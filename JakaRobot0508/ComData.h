...
//********************
 ...
 extern bool camera_running;//视频采集
 extern rs2::pipeline pipe1;
 ...
 extern unsigned char btnopt;//按钮操作
 ...
 struct SYSPARA //系统参数
{
   ...
   // QString cpname;
    ...
    QString addplc; //ROS IP
    unsigned short  portplc;//ROS port
    QString addplc1;//JAKA ip
    unsigned short  wslocport;//现场webserver port
    QString wslocip; //现场webserver IP
    unsigned short  wsremoteport;//远程webserver port portplc2
    QString addsecs;
    unsigned short  portsecs;
    QString wsremoteip;//远程webserver IP addpcplc
    QString addpcsecs;
    QString addpcphoto;
    float stepdj;
    float stepupdj;//
